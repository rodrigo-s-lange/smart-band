...
VALUES
    ('77777777-7777-7777-7777-777777777771', '11111111-1111-1111-1111-111111111111',
     '22222222-2222-2222-2222-222222222222', 'gateway-1', 'Gateway operador'),
    ('77777777-7777-7777-7777-777777777772', '11111111-1111-1111-1111-111111111111',
     '22222222-2222-2222-2222-222222222222', 'gateway-2', 'Gateway de rádio');
...
INSERT INTO interaction_requests (
    ...
    ('cccccccc-cccc-cccc-cccc-ccccccccccc1',
     ...
     decode('0102030405060708', 'hex'), 'M7K-3PX', 1, 'confirmed_pending_validation', now(), now() + interval '60 seconds'),
    ('cccccccc-cccc-cccc-cccc-ccccccccccc2',
     '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
     '33333333-3333-3333-3333-333333333333', '66666666-6666-6666-6666-666666666662',
     decode('1112131415161718', 'hex'), 'N8M-4QY', 1, 'confirmed_pending_validation', now(), now() + interval '60 seconds');
